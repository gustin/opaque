...
mod tests {
    ...
    fn registration() {
        let username = "jerryg";
        let alpha: [u8; 32] = [226, 35, 157, 8, 63, 97, 171, 99, 69, 189, 159, 141,
            180, 4, 203, 46, 116, 119, 130, 203, 210, 2, 185, 200, 136, 149, 83,
            102, 196, 13, 109, 9];
        let (beta, v, pub_s) = registration_start(&username, &alpha);

        let pub_u: [u8; 32] = [205, 174, 154, 148, 138, 21, 142, 98, 102, 212, 171,
            21, 75, 131, 129, 188, 131, 83, 38, 74, 55, 0, 75, 190, 50, 189, 47,
            107, 235, 246, 92, 85];

        let envelope: [u8; 112] = [196, 242, 45, 186, 240, 196, 70, 205, 94, 21,
                    77, 237, 22, 49, 251, 73, 174, 210, 200, 194, 199, 169, 89,
                    211, 131, 55, 55, 80, 178, 174, 75, 231, 17, 64, 84, 25, 177,
                    110, 23, 17, 220, 32, 161, 243, 76, 170, 71, 66, 131, 240,
                    105, 32, 111, 74, 127, 232, 180, 92, 204, 103, 155, 190, 247,
                    249, 93, 139, 23, 179, 39, 229, 170, 14, 5, 25, 250, 104,
                    164, 144, 187, 174, 68, 211, 10, 70, 232, 25, 157, 177,
                    236, 219, 119, 119, 14, 80, 52, 106, 147, 182, 58, 108,
                    183, 116, 183, 37, 71, 252, 47, 84, 237, 223, 76, 115];
